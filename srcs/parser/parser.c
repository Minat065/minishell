...
/* ヘルパー関数: 新しいリダイレクトを作成 */
static t_redirect *create_redirect(RedirectType type, const char *file)
{
...
/* リダイレクションのパース */
static t_redirect *parse_redirection(TokenStream *tokens)
{
...
static t_cmd *parse_simple_command(TokenStream *tokens)
{
...
static t_cmd *parse_pipeline(TokenStream *tokens, t_parse_result *result)
{
