...
int				handle_parse_error(t_parse_result *result,
...
void			set_parse_error(t_parse_result *result, t_token_stream *tokens,
					const char *msg);
void			handle_first_cmd_error(t_parse_result *result,
					t_token_stream *tokens);
int				process_pipe_commands(t_token_stream *tokens,
					t_parse_result *result, t_cmd **current_cmd);
